...
bot.setObject(
    "CONSOLE_ERROR", 
    "{user}, командная строка недоступна пользователям, не имеющих прав в сообществе {mention}"
    )
bot.setObject(
    "CONSOLE_ERROR_NOCYCLES_MESSAGE", 
    "С циклами не работаю"
    )
bot.setObject(
    "CONSOLE_ERROR_NOCYCLES_ATTACHMENT", 
    ""
    )
